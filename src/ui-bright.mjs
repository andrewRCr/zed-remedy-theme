/**
 * Bright opaque UI style — all non-syntax, non-terminal, non-player keys.
 */

import { normal, bright, lit } from "./palette.mjs";

const t = lit;

export const brightUi = {
  "background":            t.base,
  "text":                  t.foreground,
  "text.muted":            t.muted,
  ...
  "editor.indent_guide":        `${t.muted}33`,
  "editor.indent_guide_active": `${t.muted}99`,
  "editor.wrap_guide":          `${t.muted}99`,
  "editor.invisible":           `${t.muted}99`,
  ...
  "predictive":            t.muted,
  "predictive.background": `${t.muted}22`,
  "predictive.border":     `${t.muted}44`,
  ...
  "terminal.dim_foreground":    t.muted,
};
